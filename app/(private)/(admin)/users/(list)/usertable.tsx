...
export const columns: ColumnDef<User>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => <div className="mx-4">{row.original.profile.first_name}</div>,
  },
  {
    accessorKey: "profile.last_name",
    header: () => <div className="mx-4">Last Name</div>,
    cell: ({ row }) => <div className="mx-4">{row.original.profile.last_name}</div>
  },
  {
    accessorKey: "email",
    header: () => {
  ...
  },
  {
    ...
    cell: ({ row }) => <div className="mx-4 text-center">{ row.original.profile.dob ? moment(row.original.profile.dob).format('DD-MM-YYYY') : '-'}</div>,
  },
  {
    ...
    cell: ({ row }) => <div className="mx-4">{moment(row.getValue("created_at")).format('DD-MM-YYYY')}</div>,
  },
  {
    ...
    cell: ({ row }) => {
      ...
      return (
        <div className="mx-4">
          <Badge variant={isActive ? "success" : "destructive"} title={isActive ? "User is active" : "User is inactive"}>
